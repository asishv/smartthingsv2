/*
    ...
    On Windows Phone the temperature slider does not work. Fixed it by making the slider take values between 0 to 100. Ugly but works.
*/

metadata {
    definition (name: "OSRAM LIGHTIFY LED Tunable White 60W custom", namespace: "smartthings", author: "SmartThings") {
    ...
    tiles {
        ...
        controlTile("colorTempSliderControl", "device.colorTemperature", "slider", height: 1, width: 2, inactiveLabel: false, range:"(0..100)") {
